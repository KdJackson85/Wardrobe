...
namespace Wardrobe.Controllers
{
    public class OccasionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OccasionID,Occasion1")] Occasion occasion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OccasionID,Occasion1")] Occasion occasion)
        {
            if (ModelState.IsValid)
            {
