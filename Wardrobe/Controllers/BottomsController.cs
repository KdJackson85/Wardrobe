...
namespace Wardrobe.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,OccasionID,SeasonID,Type,Color,Price")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,OccasionID,SeasonID,Type,Color,Price")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
