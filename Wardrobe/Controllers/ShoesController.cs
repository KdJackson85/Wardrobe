...
namespace Wardrobe.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,OccasionID,SeasonID,Type,Color,Price")] Sho sho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,OccasionID,SeasonID,Type,Color,Price")] Sho sho)
        {
            if (ModelState.IsValid)
            {
