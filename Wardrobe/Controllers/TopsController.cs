...
namespace Wardrobe.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopsID,OccasionID,SeasonID,Type,Color,Price")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,OccasionID,SeasonID,Type,Color,Price")] Top top)
        {
            if (ModelState.IsValid)
            {
