...
namespace Wardrobe.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,OccasionID,SeasonID,Type,Color,Price")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,OccasionID,SeasonID,Type,Color,Price")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
